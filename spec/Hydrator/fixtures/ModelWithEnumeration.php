...
class ModelWithEnumeration extends Model
{
    ...
    public function getUnionStatus(): OrderStatus|ApplicationStatus
    {
        return $this->unionStatus;
    }

    public function setUnionStatus(OrderStatus|ApplicationStatus $unionStatus): self
    {
        $this->unionStatus = $unionStatus;
        return $this;
    }

    public function getUnionNullableStatus(): OrderStatus|ApplicationStatus|null
    {
        return $this->unionNullableStatus;
    }

    public function setUnionNullableStatus(OrderStatus|ApplicationStatus|null $unionNullableStatus): self
    {
        $this->unionNullableStatus = $unionNullableStatus;
        return $this;
    }
